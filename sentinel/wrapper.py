...
import uuid, os, socket, fcntl, struct, shlex, subprocess, time
...
def get_master_location():
    ...
    while not zk.exists('/redis/roles/master'):
        if elapsed > 30:
